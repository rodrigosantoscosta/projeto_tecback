...
-- funcionarios
-- senha_hash abaixo corresponde a BCrypt de 'senha123' (para testes)
INSERT INTO funcionarios (id, nome, cpf_cnpj, usuario, senha_hash, cargo, telefone, email, data_cadastro)
VALUES
    ('b2000000-0000-0000-0000-000000000001', 'Rodrigo Admin',   '47593836071', 'rodrigo.admin',  '$2a$10$7EqJtq98hPqEX7fNZaFWoOe6tyB7X6TgXVnFYhKHOD1qTLiUqRsqC', 'Gerente',   '(83) 98000-0001', 'rodrigo@oficina.com', NOW()),
    ('b2000000-0000-0000-0000-000000000002', 'Joao Mecanico',   '14567903069', 'joao.mecanico',  '$2a$10$7EqJtq98hPqEX7fNZaFWoOe6tyB7X6TgXVnFYhKHOD1qTLiUqRsqC', 'Mecanico',  '(83) 98000-0002', 'joao@oficina.com',    NOW()),
    ('b2000000-0000-0000-0000-000000000003', 'Maria Atendente', '07562078069', 'maria.atendente','$2a$10$7EqJtq98hPqEX7fNZaFWoOe6tyB7X6TgXVnFYhKHOD1qTLiUqRsqC', 'Atendente', '(83) 98000-0003', 'maria@oficina.com',   NOW());
...
VALUES
    ...
    ('d4000000-0000-0000-0000-000000000002', 'Revisao de freios dianteiros',   'EM_ANDAMENTO','2026-05-27 08:00:00', NULL,                  '2026-05-27 08:00:00', 'a1000000-0000-0000-0000-000000000002', 'c3000000-0000-0000-0000-000000000002', 'b2000000-0000-0000-0000-000000000002'),
    ('d4000000-0000-0000-0000-000000000003', 'Alinhamento e balanceamento',    'AGENDADO',    '2026-05-28 14:00:00', NULL,                  '2026-05-27 10:00:00', 'a1000000-0000-0000-0000-000000000003', 'c3000000-0000-0000-0000-000000000003', 'b2000000-0000-0000-0000-000000000001'),
