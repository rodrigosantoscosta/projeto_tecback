    ...
    <div className="min-h-screen bg-ocean-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center gap-3 mb-8">
          <div className="bg-ocean-600 p-3 rounded-xl shadow-sm">
        ...
        {status === 'error_server' && (
          <div className="mb-4 px-4 py-3 rounded-lg bg-muted border border-border text-muted-foreground text-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5" noValidate>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-white border border-input rounded-lg px-3 py-2.5 pr-10
                           ...
                           focus:ring-2 focus:ring-ring disabled:opacity-50 disabled:cursor-not-allowed transition"
                placeholder="••••••••"
              />
              <button
          ...
          <button
            ...
            className="bg-ocean-600 hover:bg-ocean-700 disabled:bg-ocean-300 disabled:cursor-not-allowed
